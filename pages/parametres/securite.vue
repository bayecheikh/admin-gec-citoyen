          ...
          <v-row align="center" justify="center">
            <v-col md="6" lg="6" sm="12">
              <form class="text-sm-left pb-5">
                <v-row>
                  <v-col md="6" lg="6" sm="12">
                    <v-text-field label="Mot de passe actuel" outlined></v-text-field>
                  </v-col>
                  <v-col md="6" lg="6" sm="12">
                    <v-text-field label="Nouveau mot de passe" outlined></v-text-field>
                  </v-col>
                </v-row>
                <v-btn class="mr-4 text-white" color="#1B73E8" @click="submit">
                  Enregistrer
                </v-btn>
              </form>
              <hr class="mb-5">
              <p><strong>Authentification en deux étapes</strong></p>
              <p><small>Utiliser un second facteur d’authentification en plus de votre mot de passe pour augmenter la
                  sécurité de votre compte</small></p>
              <span><v-icon>mdi-lock-outline</v-icon></span><span>Code de récupération</span>
              <p class="mt-5 mb-5">
                <v-btn rounded dark class="text-capitalize font-weight-light">
                  Générer des codes de récupération
                </v-btn>
              </p>
              <hr class="mb-5">
              <p><strong>Appareils & sessions</strong></p>
              <p><small>Clients web, applications de bureau et mobiles actuellement connectés avec votre compte.</small>
              </p>
              <v-simple-table>
                <template v-slot:default>
                  ...
                  <tbody>
                    <tr v-for="item in activites" :key="item.name">

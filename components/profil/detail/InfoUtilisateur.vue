        ...
        <v-col md="9" sm="12" lg="9" text-md-left>
          <div class="row">
              <div class="col-md-6 border-left">
                  <p class="info-profil mb-4" v-if="detailUtilisateur?.firstname"><span>Prénom: </span>{{detailUtilisateur?.firstname}}</p>
                  <p class="info-profil mb-4" v-if="detailUtilisateur?.lastname"><span>Nom: </span>{{detailUtilisateur?.lastname}}</p>
                  <p class="info-profil mb-4" v-if="detailUtilisateur?.sexe"><span>Sexe: </span>{{detailUtilisateur?.sexe}}</p>
                  
                  <p class="info-profil mb-4" v-if="detailUtilisateur?.email"><span>Email : </span>{{detailUtilisateur?.email}}</p>
                  <p class="info-profil mb-4" v-if="detailUtilisateur?.role"><span>Roles : </span>{{detailUtilisateur?.role}}</p>
              </div>
              <div class="col-md-6 border-left">

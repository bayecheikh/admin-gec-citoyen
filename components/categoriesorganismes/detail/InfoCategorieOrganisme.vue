        ...
        <v-col md="9" sm="12" lg="9" text-md-left>
          <div class="row">
            <div class="col-md-6 border-left">
              ...
              <p class="info-profil mb-4"><span>Nom : </span>{{ detailcategorieorganisme.name }}</p>
              <p class="info-profil mb-4"><span>Description : </span>{{ detailcategorieorganisme.description }}</p>
...
export default {
  ...
  created() {
    console.log(this.detailcategorieorganisme);
  },
